...
DCD=/home/dale/ext/completed_sbd/gsop_pep/1_pep1.8/2khosbdpep_1-1.80_2khosbdpep__21_7-4/dcd/2khosbdpep_D30_pull.dcd
F1=1
F2=8001

# general () {
#     $RUN -o $1 -seed 153 -t sbd -p sbd -r1 $2 -r2 $3 -f1 1 -f2 2000 -step 10 -psf ../../sbd_gsop.psf -dcd dcd/2khosbd_D30_pull.dcd
# }
general () {
    # hsa hsa 383 502
    # hsa hsa 510 603
    # general hsa 510 603
    $RUN -o $1 -seed 153 -t sbd -p sbd -r1 $2 -r2 $3 -f1 $F1 -f2 $F2 -step 100 -psf $PSF -dcd $DCD
}
coords () {
    $RUN -o coords -seed 153 -t sbd -p sbd -r1 383 -r2 603 -f1 1 -f2 2000 -step 10 -psf ../../sbd_gsop.psf -dcd dcd/2khosbd_D30_pull.dcd
}
tension () {
    $RUN -o tension -seed 153 -t sbd -p sbd -r1 383 -r2 603 -f1 1 -f2 2000 -step 10 -psf ../../sbd_gsop.psf -dcd dcd/2khosbd_D30_pull.dcd
}
