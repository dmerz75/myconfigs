...
def parse_arguments():
    ...
    parser.add_argument("-m","--multi",help="multi-axes: defaults to None, [1] ..")
...
for k,v in dct_plot.iteritems():
    ...
    if 1:
        ...
        datfiles = glob.glob('mt_analysis*.dat')
        num_datfile = len(datfiles)
        datfile = 'mt_analysis.dat'
        ...
        if function == 'run':
            ...
            # OPTION
            # if 0:
                print 'mt_analysis.dat must be renamed first. not running!'
            else:
                print 'running:  ',os.path.basename(ddir)
                print command
                run_command(command)

        # if function == 'emol_mt_top':
            # if os.path.exists
        ...
        if function == 'rename':
            if os.path.exists(datfile):
                ...
                print 'no mt_analysis.dat found.'
                print 'found mt_analysis_*.dat',num_datfile
                print datfiles
