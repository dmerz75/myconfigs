...
# rmsd_ala = np.loadtxt('cuda_hsp70_8__12-21-2013_0210t__ala__88/rmsd.dat')
# rmsd_nolh= np.loadtxt('cuda_hsp70_8__12-21-2013_0211t__nolh135__133/rmsd.dat')

# loaded for 1st 25
rmsd_ala = np.loadtxt('hsp70_namdgpu25_st01_hsp70_8__12-27-2013_1525t__ala__113/rmsd.dat')
rmsd_n135= np.loadtxt('hsp70_namdgpu25_st01_hsp70_8__12-27-2013_1525t__nolh135__110/rmsd.dat')


# loaded for 1st, 2nd 25, (partially complete (the 2nd traj))
# rmsd_ala = np.loadtxt('hsp70_namdgpu25_st1-2_ala/rmsd.dat')
# rmsd_n135= np.loadtxt('hsp70_namdgpu25_st1-2_nolh135/rmsd.dat')
# rmsd_n135_1 = np.loadtxt('hsp70_namdgpu25_st1-2_nolh135/rmsd.dat')
# rmsd_n135_2 = np.loadtxt('hsp70_namdgpu25_st1-2_nolh135-seed1/rmsd.dat')
...
# x1 = np.linspace(0,rmsd_ala_1.shape[0]/500.0,rmsd_ala_1.shape[0])
x1 = np.linspace(0,rmsd_ala.shape[0]/10.0,rmsd_ala.shape[0])
plt.plot(x1,rmsd_ala,'r-')

# x2 = np.linspace(0,rmsd_n135_1.shape[0]/500.0,rmsd_n135_1.shape[0])
x2 = np.linspace(0,rmsd_n135.shape[0]/10.0,rmsd_n135.shape[0])
plt.plot(x2,rmsd_n135,'g-')



# cat_command_nolh135_136229
# cat_command_nolh135_411937
ax1.legend([r"4 Alanine",
            "No Last Helix",
        ],
	     loc="upper right")
...
# plt.show()
save_pic_data(0,'','rmsd_alanolh25')
