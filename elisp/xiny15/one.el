...
;; (insert "Hello!")
;; ;; `C-x C-e' => "Hello!"
(insert " the greatest there ever was..")
(setq my-message " the greatest there ever was..")
...
(insert "Hello there! " my-name " How are you today? " my-message)
;; Hello there! Dale R. Merz Jr. How are you today?  the greatest there ever was..


;; ;; You can combine sexps into functions:
;; (defun hello () (insert "Hello, I am " my-name))
;; ;; `C-x C-e' => hello
(defun say-my-name (local-name)
  (insert "Hello " local-name ". You have been selected for jury duty.")
  )

(say-my-name my-name)
;; Hello Dale R. Merz Jr.. You have been selected for jury duty.
;; Hello Dale R. Merz Jr.. You have been selected for jury duty.
...
;; (defun find-max-square (limit)
;;   (cl-loop for x from 1 to limit
;;              for y = (* x x)
;;              until (>= y 729)
...
(defun say-hello-to-my-little-friend (name)
  (insert "\nHello, " name ", my little friend!")
  )

(say-hello-to-my-little-friend "Dale Jr.")

;; Hello, a Bazooka, my little friend!
;; Hello, Dale Jr., my little friend!
;; Hello, a Bazooka, my little friend!
;; Hello, a Bazooka, my little friend!
;; Hello, a Bazooka, my little friend!

;; Hello, Dale Jr., my little friend
(say-hello-to-my-little-friend "a Bazooka")
;; Hello, a Bazooka, my little friend!
;; Hello, a Bazooka, my little friend!
;; Hello, a Bazooka, my little friend!
;; Hello, a Bazooka, my little friend!
